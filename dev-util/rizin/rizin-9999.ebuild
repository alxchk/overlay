...
src_unpack() {
    ...
    git-r3_checkout "$TREE_SITTER_REPO_URI" "${S}/subprojects/tree-sitter-0.19.4" "$TREE_SITTER_COMMIT"

    cp -v "${S}/subprojects/packagefiles/tree-sitter-0.19.4/"meson.build "${S}/subprojects/tree-sitter-0.19.4"/
}
